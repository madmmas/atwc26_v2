...
| **[models/](models/README.md)** | Models & analytics | Prediction methodology, [shipped parity notes](models/V2_PARITY_BACKPORT.md) |
...
| Doc | Contents |
|-----|----------|
| [V1_TO_V2.md](V1_TO_V2.md) | v1 monolith → v2 AWS: rationale, comparison, **decision log (§8)** |
...
Major v1 → v2 architecture choices: [V1_TO_V2.md §8](V1_TO_V2.md#8-decision-log). Current-state diagrams: [ARCHITECTURE.md](ARCHITECTURE.md).
